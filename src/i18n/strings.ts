...
const dict = {
  ...
  // Home / hero
  "hero.eyebrow": { es: "Est. 2024 · Tec de Monterrey", en: "Est. 2024 · Tec de Monterrey" },
  "hero.subtitle": {
  ...
  "footer.tagline": { es: "BIOINFORMÁTICA · GENÓMICA", en: "BIOINFORMATICS · GENOMICS" },
  ...
  "team.pastBoards.label": { es: "Archivo / Gestiones", en: "Archive / Boards" },
  ...
  "team.pastBoards.cta": { es: "Ver Gestiones Pasadas", en: "View Past Boards" },
  ...
  "research.group01.label": { es: "— Group 01 / NDRG", en: "— Group 01 / NDRG" },
  ...
  "research.group02.label": { es: "— Group 02 / Proteomics", en: "— Group 02 / Proteomics" },
  ...
  // Archive page
  "archive.header.eyebrow": { es: "Legado · Mesas anteriores", en: "Legacy · Past boards" },
