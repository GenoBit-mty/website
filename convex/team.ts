...
const directives = [
  {
    name: 'Angel Orlando Anguiano Peña',
    role: { es: 'Presidente', en: 'President' },
    career: 'ITC',
  },
  {
    name: 'Estefanía Sauceda Camacho',
    role: { es: 'Vicepresidenta', en: 'Vicepresident' },
    career: 'IBT',
  },
  {
    name: 'Eduardo Cepeda Torres',
    role: { es: 'Director de TI', en: 'TI Director' },
    career: 'ITC',
  },
  {
    name: 'José Luis Arias López',
    role: {
      es: 'Director General de Investigación',
      en: 'Research General Director',
    },
    career: 'MSc BI',
  },
  {
    name: 'Alberto Palomino',
    role: { es: 'Director de Finanzas', en: 'Finance Director' },
    career: 'IDM',
  },
  {
    name: 'Marcelo Treviño Velazquez',
    role: { es: 'Director de Logística', en: 'Logistics Director' },
    career: 'ITC',
  },
  {
    name: 'Vanessa Gonzalez Garza',
    role: {
      es: 'Directora de Responsabilidad Social',
      en: 'Social Responsibility Director',
    },
    career: 'IBT',
  },
  {
    name: 'Silvanna Farias',
    role: { es: 'Directora de Marketing', en: 'Marketing Director' },
    career: 'ITC',
  },
  {
    name: 'Sofia Acuña Luévano',
    role: { es: 'Directora de Educación', en: 'Education Director' },
    career: 'IBT',
  },
]
...
const ndrg = [
  {
    name: 'Fedra Fernanda Mandujano Lopez',
    role: {
      es: 'Investigadora Principal: División de Neuroimagen',
      en: 'Principal Investigator: Neuroimaging Division',
    },
    career: 'IDM',
  },
  {
    name: 'Rogelio Emiliano Lara de Luna',
    role: {
      es: 'Investigador Principal: División de Biomarcadores',
      en: 'Principal Investigator: Biomarkers Division',
    },
    career: 'IBT',
  },
  {
    ...
    role: {
      ...
      en: 'Developer and Researcher',
    },
    career: 'IDM',
  },
  {
    name: 'Daniela Herrera García',
    role: {
      es: 'Desarrolladora e Investigadora',
      en: 'Developer and Researcher',
    },
    career: 'ITC',
  },
  ...
  {
    name: 'Andrea de Jesús Olivares Segura',
    role: { es: 'Investigadora', en: 'Researcher' },
    career: 'MC',
  },
  {
    name: 'Luis Michel Zamora',
  ...
  {
    name: 'Sebastián Rosas',
    role: { es: 'Investigador', en: 'Researcher' },
    career: 'IBT',
  },
  {
    name: 'Emiliano Hervert de la Cruz',
    role: { es: 'Desarrollador', en: 'Developer' },
    career: 'IDM',
  },
  {
    name: 'Sofia Moreno Lopez',
    role: { es: 'Desarrolladora', en: 'Developer' },
    career: 'ITC',
  },
  {
    name: 'Gilberto Angel Camacho',
    role: { es: 'Desarrollador', en: 'Developer' },
    career: 'ITC',
  },
  {
    name: 'Sebastián Peñafiel',
    role: { es: 'Desarrollador', en: 'Developer' },
    career: 'ITC',
  },
]
...
const proteomics = [
  {
    name: 'Angel Orlando Anguiano Peña',
    role: {
      es: 'Investigador Principal: Proteómica dentro de AlphaFold',
      en: 'Principal Investigator: Proteomics within AlphaFold',
    },
    career: 'ITC',
  },
  {
    name: 'Zyanya Zapata Lozano',
    role: {
      es: 'Investigadora Principal: Biología Molecular',
      en: 'Principal Investigator: Molecular Biology',
    },
    career: 'IBT',
  },
  {
  ...
  {
    name: 'Daniela Garcia Garza',
    role: { es: 'Investigadora', en: 'Researcher' },
    career: 'IBT',
  },
  {
    name: 'Fátima Castillo Aguirre',
    role: { es: 'Desarrolladora', en: 'Developer' },
    career: 'IBT',
  },
  {
    name: 'Juana Isabel Cruz Arango',
    role: { es: 'Investigadora', en: 'Researcher' },
    career: 'IBT',
  },
]
...
const studentCommunity = [
  {
    name: 'Luis Antonio Bolaina Dominguez',
  ...
  {
    name: 'Isaac Diaz',
    role: { es: 'Coordinador de Finanzas', en: 'Finance Coordinator' },
    career: 'IBT',
  },
  {
    name: 'Magda Gianina Colunga Minutti',
    role: {
      es: 'Coordinadora de Finanzas y Logística',
      en: 'Finance and Logistics Coordinator',
    },
    career: 'ITC',
  },
  {
    name: 'Alejandro Longoria Lozano',
    role: { es: 'Coordinador de Logística', en: 'Logistics Coordinator' },
    career: 'IBT',
  },
  {
    name: 'Emilio Barragán Godoy',
    role: { es: 'Coordinador de Logística', en: 'Logistics Coordinator' },
    career: 'ITC',
  },
  {
    name: 'Ángeles Escareño Garay',
    role: {
      es: 'Coordinadora de Responsabilidad Social',
      en: 'Social Responsibility Coordinator',
    },
    career: 'IBT',
  },
  {
    name: 'Ivanna Janis Galvez Lara',
    role: { es: 'Subdirectora de Marketing', en: 'Marketing subdirector' },
    career: 'IBT',
  },
  {
    name: 'Marisol Guedea',
    role: { es: 'Coordinadora de Marketing', en: 'Marketing coordinator' },
    career: 'IBT',
  },
]
